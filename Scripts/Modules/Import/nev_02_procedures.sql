...
/* ************************************************** Praticiens ************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_praticien(
...
/* ************************************************** Organismes ************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_destinataire(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_organisme(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_taux(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_contrat(
...
/* ************************************************** Clients ***************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_client(
  AClientID integer,
  ATypeClient char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_client_liaison(
  AIDCollectivite integer,
  AIDClient integer)
as
begin
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_couv_amo(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_couv_amc(
...
/* ********************************************************************************************** */
create or alter procedure ps_nev_creer_client_contrat(
  AClientID integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_maj_org_client(
  ANumeroInsee varchar(15),
  ARegime integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_maj_couv_client(
  ANumeroInsee varchar(15),
...
/* ************************************************** Produits **************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_fournisseur(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_famille(
  ARang char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_zone_geo(
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_produit(
  AProduitID dm_code,
  ACodeCIP7 char(7),
  ...
  AStockProtection integer, --pas utile si stock min calculé
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_produit_geo(
  AProduitID integer,
  AQuantite numeric(5),
  APriorite char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_stock(
  AProduitID dm_code,
  AGestionReserve char(1),
  AGestionAutomate char(1),
  ACodeGestion varchar(2),
...
/* ********************************************************************************************** */
create or alter procedure ps_nev_creer_histo_vente_m(
  AProduitID integer,
  AMois integer,
  AAnnee integer,
...
/* ********************************************************************************************** */
create or alter procedure ps_nev_creer_histo_vente(
  AProduitID integer,
  ADateDerniereVente date,
  AVendues0 integer,
  AVendues1 integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_produits_lpp(
  AProduitID dm_code,
  APrestation char(3),
  ACodeTIPSLPP varchar(13)
 )
...
/* ************************************************** Encours ***************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_avance(
  AClientID integer,
  ADate date,
  AProduitID integer,
  AQuantite numeric(5),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_produit_du(
  AClientID integer,
  ADate date,
  AProduitID integer,
  AQuantite numeric(5),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_credit(
  AClientID integer,
  ATypeClient char(1),
  AIDCollectivite integer,
  AQualite integer,
...
values(:strClientID,
     ...
     iif(((:ADateDernierReglement is null) or (:ADateDernierReglement < :ADateDerniereVisite)),coalesce(:ADateDerniereVisite,current_date), :ADateDernierReglement),
     :AMontantCredit);
...
/* ************************************************** Autres donnees ********************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_operateur(
  AVendeurID integer,
  ANomPrenom varchar(20),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_histo_ent(
  ADateCreation date,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_histo_lig(
  ADateCreation date,
  AHistoriqueClientEntete integer,
...
create or alter procedure ps_nev_creer_fact_att(
  AClientID integer,
  ANumeroFacture integer,
  ADateFacture date)
as
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_commande(
  ADateCommande date,
  ADateReception date,
  AEtat char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_comm_ligne(
  ADateCommande date,
  ANumeroCommandeJour integer,
  AIDProduit integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_catalogue(
  AIDFournisseur integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_nev_creer_catalogue_prod(
  AIDFournisseur integer,
  AIDCatalogue integer,
  AIDProduit integer,
  Atypeg integer,
...
/* ********************************************************************************************** */
create or alter procedure ps_nev_creer_document(
  AIDDocument integer,
  ADateCreation date,
  AFichier varchar(255),
  ANumeroFacture varchar(20),
  AType varchar(2), 
  AIDClient integer
)                                                 
as
declare variable numero_facture dm_code;
declare variable chemin_projet varchar(255);
begin

  select  replace(mon$database_name,'PHA.FDB','SCAN\') --' le dossier des scans doit se nome "scan"
  from mon$database
  into chemin_projet;
  ...
  values(next value for seq_document,
         ...
         2, --pdf
         :AIDClient,
         'Attestation mutuelle '||extract(YEAR from :ADateCreation),
         :chemin_projet||:AFichier,
         'Attestation mutuelle '||extract(YEAR from :ADateCreation),
         :ADateCreation);
  else
  begin
    ...
    values(next value for seq_document,
           ...
           2, --pdf
           :AIDClient,
           'Scan Ordonnance '||:ANumeroFacture||' du '||:ADateCreation,
           :chemin_projet||:AFichier,
           'Scan Ordonnance '||:ANumeroFacture||' du '||:ADateCreation,
           :ADateCreation);
  end       
...
/* ********************************************************************************************** */
create or alter procedure ps_nev_creer_carte_prog_rel(
  AIDClient integer,
  numcarte char(13)
)
as
