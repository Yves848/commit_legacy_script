...
/* ************************************************** Exceptions ************************************************** */
/* **************************************************************************************************************** */
create exception exp_smartrx_couverture_client 'Client inexistant/supprimé/purgé';
create exception exp_smartrx_couv_amo_incoh 'Couverture AMO associé à un organisme AMC';
create exception exp_smartrx_couv_amc_incoh 'Couverture AMC associé à un organisme AMO';
create exception exp_smartrx_client_non_trouve 'Client non trouvé';
create exception exp_smartrx_fou_cat_non_trouve 'Fournisseur associé au catalogue introuvable';

/* **************************************************************************************************************** */
/* ************************************************** Praticiens ************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_praticien(
...
/* ************************************************** Organismes ************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_destinataire(
  ADestinataireID integer,
  ANom varchar(25),
  ARue1 varchar(25),
  ARue2 varchar(25),
  ACodePostal char(5),
...
begin
  --TODO : requete à faire quand on aura trouvé un base smartrx qui possede afzdes 
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_organisme(
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_taux(
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_contrat(
...
begin
  ...
  begin
   -- ------------------- couvertures AMO ---------------------- 
    ...
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'PH1', :ATauxPH1);
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'PH4', :ATauxPH4);
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'PH7', :ATauxPH7);
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'PH2', :ATauxPH2);
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'ADD', :ATauxLPP);
    execute procedure ps_smartrx_creer_taux(:strCouvertureID, null, 'PMR', :ATauxPH7);
  end
  else
  begin
  -- ------------------- couvertures AMC ---------------------- 
    ...
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'PH1', :ATauxPH1);
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'PH4', :ATauxPH4);
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'PH7', :ATauxPH7);
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'PH2', :ATauxPH2);
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'AAD', :ATauxLPP);
    execute procedure ps_smartrx_creer_taux(null, :AContratTypeID, 'PMR', :ATauxPH7);  
  end
end;
...
/* ************************************************** Clients ***************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_client(
  AClientID integer,
  ATypeClient char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_client_liaison(
  AIDCollectivite integer,
  AIDClient integer)
as
begin
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_couv_amo(
...
begin
  ...
  begin
    ...
    exception exp_smartrx_couv_amo_incoh;
end;


/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_couv_amc(
...
begin
  ...
  begin
    ...
    exception exp_smartrx_couv_amc_incoh;
end;

/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_client_contrat(
  AClientID integer,
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        execute procedure ps_smartrx_creer_couv_amo(:strOrganismeID, :AContratTypeID);
      ...
      begin
        execute procedure ps_smartrx_creer_couv_amc(:strOrganismeID, AContratTypeID);
  --select iif(identifiant_national='99999997'or identifiant_national='27000000','1','2') from t_organisme where t_organisme_id = :strOrganismeID into :chModeGestion;
    ...
    exception exp_smartrx_couverture_client;
end;

/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_maj_org_client(
  ANumeroInsee varchar(15),
  ARegime integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_maj_couv_client(
  ANumeroInsee varchar(15),
  ...
  begin
    begin
      ...
      into :lStrClientID,
           :lStrOrganismeAMOID;
    when sqlcode -811 do
      exception  exp_smartrx_client_non_trouve;
    end
...
/* ************************************************** Produits **************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_fournisseur(
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_famille(
  ARang char(1),
...
create or alter procedure ps_alliance_creer_produit_gamme(
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_zone_geo(
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_produit(
  AProduitID dm_code,
  ACodeCIP7 char(7),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_produit_geo(
  AProduitID integer,
  AQuantite numeric(5),
  APriorite char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_stock(
  AProduitID dm_code,
  AGestionReserve char(1),
  AGestionAutomate char(1),
  ACodeGestion varchar(2),
...
begin
   ...
   if ((AGestionAutomate = 'O') OR (AGestionAutomate = 'M')) then
    begin
      ...
      execute procedure ps_smartrx_creer_produit_geo(:AProduitID, :AStockRayon, '2',  :AStockMiniRayon,  AStockMaxiRayon  , :AZoneGeoRayon);

    end
    else
      execute procedure ps_smartrx_creer_produit_geo(:AProduitID, :AStockRayon, '1', iif(:AGestionReserve = 'O', :AStockMiniRayon, iif(:AForcee = 'O', :AStockProtectionForce, :AStockProtection)),  iif(:AGestionReserve = 'O', :AStockMaxiRayon, :AStockMaxi) , :AZoneGeoRayon);
    if (AGestionReserve = 'O') then
      execute procedure ps_smartrx_creer_produit_geo(:AProduitID, :AStockReserve, '0', null, null, :AZoneGeoReserve);
end;   

/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_produit_code(
  AProduitID dm_code,
  ACode varchar(13),
  p_type integer)
as
...
/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_histo_vente_m(
  AProduitID integer,
  AMois integer,
  AAnnee integer,
...
/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_histo_vente(
  AProduitID integer,
  ADateDerniereVente date,
  AVendues0 integer,
  AVendues1 integer,
...
begin
  ...
  begin
    ...
    if (flag_depart = '1') then
        execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues0, :AActes0) returning_values :intMois, :intAnnee;
    if (AVendues1>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues1, :AActes1) returning_values :intMois, :intAnnee;
    if (AVendues2>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues2, :AActes2) returning_values :intMois, :intAnnee;
    if (AVendues3>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues3, :AActes3) returning_values :intMois, :intAnnee;
    if (AVendues4>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues4, :AActes4) returning_values :intMois, :intAnnee;
    if (AVendues5>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues5, :AActes5) returning_values :intMois, :intAnnee;
    if (AVendues6>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues6, :AActes6) returning_values :intMois, :intAnnee;
    if (AVendues7>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues7, :AActes7) returning_values :intMois, :intAnnee;
    if (AVendues8>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues8, :AActes8) returning_values :intMois, :intAnnee;
    if (AVendues9>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues9, :AActes9) returning_values :intMois, :intAnnee;
    if (AVendues10>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues10, :AActes10) returning_values :intMois, :intAnnee;
    if (AVendues11>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues11, :AActes11) returning_values :intMois, :intAnnee;
    if (AVendues12>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues12, :AActes12) returning_values :intMois, :intAnnee;
    if (AVendues13>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues13, :AActes13) returning_values :intMois, :intAnnee;
    if (AVendues14>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues14, :AActes14) returning_values :intMois, :intAnnee;
    if (AVendues15>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues15, :AActes15) returning_values :intMois, :intAnnee;
    if (AVendues16>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues16, :AActes16) returning_values :intMois, :intAnnee;
    if (AVendues17>0) then flag_depart = '1';
    if (flag_depart = '1') then
            execute procedure ps_smartrx_creer_histo_vente_m(:AProduitID, :intMois, :intAnnee, :AVendues17, :AActes17) returning_values :intMois, :intAnnee;
  end
end;

/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_produits_lpp(
  AProduitID dm_code,
  APrestation char(3),
  ACodeTIPSLPP varchar(13)
 )
...
/* ************************************************** Encours ***************************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_avance(
  AClientID integer,
  ADate date,
  AProduitID integer,
  AQuantite numeric(5),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_produit_du(
  AClientID integer,
  ADate date,
  AProduitID integer,
  AQuantite numeric(5),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_credit(
  AClientID integer,
  ATypeClient char(1),
  AIDCollectivite integer,
  AQualite integer,
...
/* ************************************************** Autres donnees ********************************************** */
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_operateur(
  AVendeurID integer,
  ANomPrenom varchar(20),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_histo_ent(
  ADateCreation date,
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_histo_lig(
  ADateCreation date,
  AHistoriqueClientEntete integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_commande(
  ADateCommande date,
  ADateReception date,
  AEtat char(1),
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_comm_ligne(
  ADateCommande date,
  ANumeroCommandeJour integer,
  AIDProduit integer,
  AQuantiteCommandee integer,
  AUnitesGratuites integer,
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_catalogue(
  AIDFournisseur integer,
...
begin
  ...
  begin  
    ...
    exception exp_smartrx_fou_cat_non_trouve;
end;

/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_catalogue_prod(
  AIDFournisseur integer,
  AIDCatalogue integer,
  AIDProduit integer,
  Atypeg integer,
...
begin
  ...
  EXECUTE PROCEDURE ps_smartrx_creer_catalogue(:AIDFournisseur,
                                              :AIDCatalogue,  
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_prog_avantage(
  AIDCarte integer,
  ADateCreation date,
  AFinValidite date,
  AMontantMinimum float,
  AQuantiteMinimum integer, 
  APassageMinimum integer,
  ARemise float)
as
begin
...
/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_avantage_cli(
  AIDClient integer,
  ATypeCarte char(1),
  ADateCreation date,
  AChiffreAffaire float,
  ANombreProduitsAchetes integer, -- TODO non utilisé, à faire 
  ANombreProduitsAchetesMini integer,-- TODO non utilisé, à faire
  ARemise float)-- TODO non utilisé, à faire
as
declare variable cf varchar(50);
begin

    select first 1 t_programme_avantage_id
  ...
  values(next value for seq_programme_avantage_client,
     ...
     :AIDClient,
     :ADateCreation,
     dateadd(1 year to :ADateCreation),
   --  :ANombreProduitsAchetes,   -- Steph : ancien encours intitial mais aucun interet selon moi
     :AChiffreAffaire,
   0);
end;

/* **************************************************************************************************************** */
create or alter procedure ps_smartrx_creer_prog_produit(
  AIDProduit integer,
  ACarteFid integer)
as
declare variable cf varchar(50);
begin
    insert into t_programme_avantage_produit(t_programme_avantage_produit_id,
                                         t_programme_avantage_id,
                                         t_produit_id)
    values(next value for seq_programme_avantage_produit,
           :ACarteFid,
           :AIDProduit);
end;
...
/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_document(
  AIDClient integer,
  ALibelle varchar(50),
  AFichier varchar(255))
as
declare variable numero_facture dm_code;
declare variable client_id dm_code;
declare variable date_acte date;
begin
  ...
  begin
    ...
    select t_client_id, date_acte from t_historique_client where numero_facture = :numero_facture into :client_id, date_acte; 
    insert into t_document(t_document_id,
                         type_entite,
                         t_entite_id,
                         t_date,
...
/* ********************************************************************************************** */
create or alter procedure ps_smartrx_creer_carte_prog_rel(
  AIDClient integer,
  numcarte char(13)
)
as
