inherited frTransfertYZY: TfrTransfertYZY
  inherited wzDonnees: TJvWizard
    ...
    object wipProgrammesFidelites: TJvWizardInteriorPage [8]
      Header.Height = 50
  ...
  inherited xpcOutils: TJvXPContainer
    Color = clWhite
    inherited xpbEntetesTraitements: TJvXPBar [0]
      Top = 374
      ExplicitTop = 374
    end
    inherited xpbAccesBD: TJvXPBar [1]
      Height = 204
      Items = <
        item
        ...
        item
          Action = actAccesYZYEtatFusion
        end>
      ExplicitHeight = 204
    end
    inherited sbxTraitements: TScrollBox [2]
      Top = 409
      Height = 74
      TabOrder = 2
      ExplicitTop = 409
  ...
  inherited limOutils: TImageList
    Bitmap = {
      494C010106001400380010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited lacOutils: TActionList
    Top = 200
    object actAccesBDInitialisation: TAction
      Caption = 'Initialisation'
      Enabled = False
    end
    object actAccesYZYEtatFusion: TAction
      Category = 'Acc'#232's YZY'
      Caption = 'Etat de la fusion'
      OnExecute = actAccesYZYEtatFusionExecute
    end
  end
