...
type
  TfrFrameVisualisation = class(TFrame)
    pnlCritere: TPanel;
    lblCritere: TLabel;
    edtCritere: TEdit;
  ...
  TFrFrameVisualisationClasse = class of TfrFrameVisualisation;
...
constructor TfrFrameVisualisation.Create(Aowner: TComponent; AProjet : TProjet);
begin
...
procedure TfrFrameVisualisation.Hide;
begin
  inherited;
...
destructor TfrFrameVisualisation.Destroy;
begin
  Hide;
...
procedure TfrFrameVisualisation.edtCritereEnter(Sender: TObject);
begin
  edtCritere.Color := CL_JAUNE_SELECTION;
end;

procedure TfrFrameVisualisation.edtCritereExit(Sender: TObject);
begin
 edtCritere.Color := CL_GRIS_CLAIR;
end;

procedure TfrFrameVisualisation.edtCritereKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrFrameVisualisation.grilleLGPI(Sender: TObject;
...
procedure TfrFrameVisualisation.grilleLGPIsimple(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
...
procedure TfrFrameVisualisation.Show;
begin
  inherited;
