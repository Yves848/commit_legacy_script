unit mdlFenetreVisualisation_fr;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ImgList, mdlProjet, mdlFrameVisualisation_fr,
...
type
  ...
  private
    ...
    FFrames : array of array of TfrFrameVisualisation;
    FFrameActive : TfrFrameVisualisation;
    FProjet: TProjet;
  public
    { Déclarations publiques }
    property Projet : TProjet read FProjet;
    property FrameActive : TfrFrameVisualisation read FFrameActive;
...
const
  ...
  C_BOUTON_PRODUITS = 0;
  C_BOUTON_CODIFICATIONS = 1;
  C_BOUTON_FOURNISSEURS = 2;
  C_BOUTON_PROMOTIONS = 3;
  ...
  C_BOUTON_FACTURES_ATTENTES = 3;
  C_BOUTON_COMMANDES_EN_COURS = 4;
...
uses mdlClients_fr,
  ...
  mdlProduits_fr, mdlFournisseurs_fr,
  mdlCodifications_fr, mdlHistoDelivrances_fr,
  mdlCredits_fr, mdlVignettesAvancees_fr,
  mdlPromotions_fr, mdlProduitsDus_fr,
  mdlFacturesAttentes_fr, mdlCommandesEnCours_fr,
  mdlVisualisationPHA_fr;
...
begin
  FFrameActive.Hide;
  dmVisualisationPHA_fr.trPHA.Commit;
end;
...
begin
  ...
  dmVisualisationPHA_fr.trPHA.StartTransaction;
...
begin
  case obNavigation.ActivePageIndex of
    ...
    C_PAGE_GESTION_PRODUITS :
      case Index of
        C_BOUTON_PRODUITS : ChargerFrame(TfrProduits);
        C_BOUTON_CODIFICATIONS : ChargerFrame(TfrCodifications);
    ...
    C_PAGE_GESTION_ENCOURS :
      case Index of
        ...
        C_BOUTON_FACTURES_ATTENTES : ChargerFrame(TfrFacturesAttentes);
        C_BOUTON_COMMANDES_EN_COURS : ChargerFrame(TfrCommandesEnCours);
      end;
  end;
end;
...
var
  i, lIntNbOcc : Integer;
begin
  dmVisualisationPHA_fr.ConstruireVuesPrestations;
