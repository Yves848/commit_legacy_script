...
begin
  ...
  dmOutilsPHAPHA_fr.setInventaire.Transaction.StartTransaction;
...
begin
  ...
  with dmOutilsPHAPHA_fr.setInventaire do
    if Active then
    begin
      Close;
      Transaction.Commit;
...
begin
  ...
  begin
    ...
    while not EOF do
    begin
      lSgTotalPAHT := lSgTotalPAHT + setInventaireTOTAL_PRIX_ACHAT_CATALOGUE.AsFloat;
      lSgTotalPVTTC := lSgTotalPVTTC + setInventaireTOTAL_PRIX_VENTE.AsFloat;
      lSgTotalPAMP := lSgTotalPAMP + setInventaireTOTAL_PAMP.AsFloat;
