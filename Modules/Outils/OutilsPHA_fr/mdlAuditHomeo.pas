...
uses
  ...
  mdlDialogue, ImgList, ToolWin, ActnList, uib, DBClient, JvMenus;
  ...
  case pCtrlAuditHomeo.ActivePageIndex of
    C_PAGE_AUDITHOMEO_CIP :
      begin
        ...
        ChargerDataSet(dmOutilsPHAPHA_fr.setAuditHomeoCIP, cdsHPetitPrix, 'type_homeo = 2'); MiseEnFormeGrille(grdAHCIPPetitPrix);
        ChargerDataSet(dmOutilsPHAPHA_fr.setAuditHomeoCIP, cdsHGrandPrix, 'type_homeo = 1'); MiseEnFormeGrille(grdAHCIPGrandPrix);
    ...
    C_PAGE_AUDITHOMEO_FOURNISSEUR :
      begin
        dmOutilsPHAPHA_fr.trDataset.StartTransaction;
        ChargerDataSet(dmOutilsPHAPHA_fr.setAuditHomeoFD, cdsHPetitPrix, 'type_homeo = 2'); MiseEnFormeGrille(grdAHFourPetitPrix);
        ChargerDataSet(dmOutilsPHAPHA_fr.setAuditHomeoFD, cdsHGrandPrix, 'type_homeo = 1'); MiseEnFormeGrille(grdAHFourGrandPrix);
        dmOutilsPHAPHA_fr.trDataset.Commit;        
      end;

    C_PAGE_AUDITHOMEO_FORCAGE :
      begin
        dmOutilsPHAPHA_fr.setFournisseursDirect.Open;
      end;
  end;
end;
