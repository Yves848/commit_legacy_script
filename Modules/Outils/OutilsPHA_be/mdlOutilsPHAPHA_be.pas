...
type
  TdmOutilsPHAPHA_be = class(TdmModuleOutils)
...
var
  dmOutilsPHAPHA_be: TdmOutilsPHAPHA_be;

implementation

{$R *.dfm}

procedure TdmOutilsPHAPHA_be.DataModuleCreate(Sender: TObject);
begin
  inherited;
...
procedure TdmOutilsPHAPHA_be.setRepartiteurAfterPost(
  DataSet: TDataSet);
var
...
procedure TdmOutilsPHAPHA_be.trDatasetEndTransaction(Sender: TObject;
  var Mode: TEndTransMode);
begin
  inherited;
...
procedure TdmOutilsPHAPHA_be.setRepartiteurAfterOpen(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdmOutilsPHAPHA_be.setRepartiteurBeforeClose(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdmOutilsPHAPHA_be.setOrganismesAfterPost(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmOutilsPHAPHA_be.setOrganismesAfterOpen(DataSet: TDataSet);
begin
  inherited;
