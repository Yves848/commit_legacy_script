inherited frModuleImport: TfrModuleImport
  AutoScroll = True
  inherited wzDonnees: TJvWizard
    inherited wipBienvenue: TJvWizardInteriorPage
      Header.Subtitle.Font.Color = clLime
      ...
      object grdFichiersManquants: TPIDBGrid
        Left = 0
        Top = 50
        Width = 93
        Height = 48
        Align = alClient
        DataSource = dsFichiersManquants
        ...
        HauteurEntetes = 17
        Entetes = <>
        SurDessinerColonne = grdFichiersManquantsSurDessinerColonne
        SurAppliquerProprietesCellule = grdFichiersManquantsSurAppliquerProprietesCellule
        ...
        Columns = <
          ...
          item
            ...
            OptionsControle.ProgressBar.Min = 0
            Options = [ocExport, ocImpression]
            SurCocher = grdFichiersManquantsColumns3SurCocher
          end
          item
            Expanded = False
    ...
    object wipConversions: TJvWizardInteriorPage [8]
      Header.Height = 50
      Header.ParentFont = False
      Header.Title.Color = clNone
      Header.Title.Text = 'Conversions des organismes AMO'
      ...
      Header.Subtitle.Font.Style = [fsBold]
      Caption = 'Conversions'
      OnEnterPage = wipConversionsEnterPage
      object tctlConversions: TTabControl
        Left = 0
        Top = 50
        Width = 93
        Height = 187
        ...
        Style = tsFlatButtons
        TabOrder = 0
        OnChange = tctlConversionsChange
        OnChanging = tctlConversionsChanging
      end
    end
  end
  ...
  inherited mnuMenuPrincipale: TJvMainMenu
    object mnuReprise: TMenuItem
      Caption = '&Reprise'
      object mnuRepriseConversions: TMenuItem
        Caption = 'Conversions'
        object mnuRepriseConversionsImporter: TMenuItem
          Caption = 'Importer'
          OnClick = mnuRepriseConversionsImporterClick
        end
        object mnuRepriseConversionsExporter: TMenuItem
          Tag = 1
          Caption = 'Exporter'
          OnClick = mnuRepriseConversionsExporterClick
        end
      end
      object N1: TMenuItem
        Caption = '-'
      end
      object mnuRepriseConversionTIFF: TMenuItem
        Caption = 'Console de suivi de la conversion vers TIFF'
        OnClick = mnuRepriseConversionTIFFClick
      end
    end
    object mnuOutils: TMenuItem
      Caption = '&Outils PHA'
      object mnuOutilsInventaire: TMenuItem
        Caption = '&Inventaire'
        OnClick = mnuOutilsInventaireClick
      end
  ...
  object dsFichiersManquants: TDataSource
    DataSet = dmModuleImportPHA.setFichiersManquants
    Left = 416
    Top = 344
  end
end
