inherited frModuleTransfert: TfrModuleTransfert
  AutoSize = True
  ...
  inherited limOutils: TImageList
    Bitmap = {
      494C010106001000200010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited lacOutils: TActionList
    ...
    object actKitMigrationVisualisation: TAction
      ...
      ImageIndex = 2
      OnExecute = actKitMigrationVisualisationExecute
    end
    ...
    object actKitMigrationAfficherErreurs: TAction
      ...
      OnExecute = actKitMigrationAfficherErreursExecute
    end
  end
end
