inherited frmRechercheFournisseurRef: TfrmRechercheFournisseurRef
  Left = 391
  Top = 313
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbGrdFournisseurRef: TPIDBGrid
    Left = 0
    Top = 0
    Width = 730
    Height = 543
    Align = alClient
    DataSource = dsFournisseursRef
    ...
    TitleFont.Style = []
    OnDblClick = dbGrdFournisseurRefDblClick
    OnKeyDown = dbGrdFournisseurRefKeyDown
  ...
  object dsFournisseursRef: TDataSource
    DataSet = dmModuleImportPHA.setFournisseursRef
    Left = 368
    Top = 368
  end
end
