...
type
  TfrNEVConfiguration = class(TfrConfiguration)
...
{ TfrNEVConfiguration }
constructor TfrNEVConfiguration.Create(Aowner: TComponent; AModule: TModule);
var
  lIntLigne : Integer;
...
begin
 ...
 {   if FileExists(Projet.RepertoireProjet + 'A_FZDES.D') then
      with TFichierNEV.Create(Projet.RepertoireProjet + 'A_FZDES.D') do
      begin
        lIntLigne := 1;
        repeat
          Suivant;
...
procedure TfrNEVConfiguration.Enregistrer;
var
  i : Integer;
begin
  inherited;
...
procedure TfrNEVConfiguration.Initialiser(AOptions : IXMLNode);
begin
  inherited;
...
procedure TfrNEVConfiguration.SpeedButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrNEVConfiguration.SpeedButton2Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
...
procedure TfrNEVConfiguration.SpeedButton3Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
