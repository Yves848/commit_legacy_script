unit mdlPHARMONYFRConfiguration;
...
type
  TfrPHARMONYFRConfiguration = class(TfrConfiguration)
...
{ TfrPHARMONYFRConfiguration }
constructor TfrPHARMONYFRConfiguration.Create(Aowner: TComponent; AModule: TModule);
var
  lIntLigne : Integer;
...
begin
 ...
 {   if FileExists(Projet.RepertoireProjet + 'A_FZDES.D') then
      with TFichierPHARMONYFR.Create(Projet.RepertoireProjet + 'A_FZDES.D') do
      begin
        lIntLigne := 1;
        repeat
          Suivant;
...
procedure TfrPHARMONYFRConfiguration.Enregistrer;
var
  i : Integer;
begin
  inherited;
...
procedure TfrPHARMONYFRConfiguration.Initialiser(AOptions : IXMLNode);
begin
  inherited;
...
procedure TfrPHARMONYFRConfiguration.SpeedButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrPHARMONYFRConfiguration.SpeedButton2Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
...
procedure TfrPHARMONYFRConfiguration.SpeedButton3Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
