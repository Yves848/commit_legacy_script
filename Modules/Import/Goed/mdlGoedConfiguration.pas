...
type
  TfrGoedConfiguration = class(TfrConfiguration)
...
{ TfrXLSoftConfiguration }
constructor TfrGoedConfiguration.Create(Aowner: TComponent; AModule: TModule);
var
  lIntLigne : Integer;
...
begin
 ...
 {   if FileExists(Projet.RepertoireProjet + 'A_FZDES.D') then
      with TFichierDynaCaisse.Create(Projet.RepertoireProjet + 'A_FZDES.D') do
      begin
        lIntLigne := 1;
        repeat
          Suivant;
...
procedure TfrGoedConfiguration.Enregistrer;
var
  i : Integer;
begin
  inherited;
...
procedure TfrGoedConfiguration.Initialiser(AOptions : IXMLNode);
begin
  inherited;
...
procedure TfrGoedConfiguration.SpeedButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrGoedConfiguration.SpeedButton2Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
...
procedure TfrGoedConfiguration.SpeedButton3Click(Sender: TObject);
var i : integer;
begin
  inherited;
  for i := 1 to grdDestinataires.RowCount - 1 do
