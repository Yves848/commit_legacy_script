inherited frPharmony: TfrPharmony
  inherited wzDonnees: TJvWizard
    ...
    object wipCartesFidelites: TJvWizardInteriorPage [9]
      Header.Height = 50
      ...
      Caption = 'Cartes Fid'#233'lit'#233's'
      Enabled = False
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object grdCartesFidelites: TPIStringGrid
        Left = 0
        Top = 50
        Width = 93
        Height = 187
